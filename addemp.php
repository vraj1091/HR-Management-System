            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Post" name="post" required="required">
                        </div>
...
<br>
<div>
                    <input type="file" name="import emp data" class="form-control">
                    <br>
                    <br>
                    <button class="btn btn--radius btn--green" type="submit" name="data">Import</button>
                    </form>
                </div>
            </div>
        </div>
