...
$result = mysqli_query($conn, "UPDATE `employee` SET `firstName`='$firstname',`lastName`='$lastname',`email`='$email',`birthday`='$birthday',`gender`='$gender',`contact`='$contact',`post`='$post',`address`='$address',`dept`='$dept',`degree`='$degree' WHERE id=$id");
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" name="post" value="<?php echo $post;?>">
                        </div>
